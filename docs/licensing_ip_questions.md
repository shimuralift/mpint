# licensing_ip_questions.md

This file, *licensing_ip_questions.md*, brings up some questions regarding the legal status of  
code agent generated code.
Only the prompt is shown, but not the code agent's response.
...
relative to this prompt. What's the status quo and what are your - publicly available -  
